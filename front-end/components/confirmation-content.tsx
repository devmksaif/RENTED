          ...
          <div className="order-items">
            <div className="order-item">
              <div className="item-image">
                <Image src="/placeholder.svg?height=80&width=80" alt="Macbook Pro" width={80} height={80} />
              </div>
            ...
            <div className="order-item">
              <div className="item-image">
                <Image src="/placeholder.svg?height=80&width=80" alt="Pro Display XDR" width={80} height={80} />
              </div>
              <div className="item-details">
          ...
          <div className="rental-protection">
            ...
            <div className="protection-options">
              <label className="protection-option">
                <input type="radio" name="protection" value="yes" checked />
          ...
          <div className="terms-section">
            <label className="terms-checkbox">
              ...
              <span className="checkbox-text">
                I agree to the <Link href="#">Terms & Conditions</Link> and <Link href="#">Rental Agreement</Link>
              </span>
            </label>
          </div>
